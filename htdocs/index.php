...
?>
	...
	<article>
		<section>
			<p>Welcome to the <i>New OSM Contributors in United States Demo</i> Panel. Below you can find a list of the latest new contributors. Click one to open their file.</p>
		</section>
